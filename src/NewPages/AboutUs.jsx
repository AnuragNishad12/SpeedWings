    ...
    <div className="font-sans bg-gray-50 ">
      ...
      {/* <div className="relative bg-black text-white py-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="h-1 w-24 bg-purple-600 mb-8"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-purple-600 p-8 text-white rounded-lg shadow-lg">
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <div className="h-1 w-24 bg-purple-600 mx-auto my-4"></div>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-xl">
                  ...
                  <div className="px-6 py-6 bg-white border-t-4 border-purple-600">
      ...
      {/* <div className="bg-purple-600 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="/contact" className="bg-white text-purple-600 px-8 py-3 rounded-full font-medium hover:bg-gray-100 transition-colors">
              Contact Us
            </a>
            <a href="/enquiry" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-medium hover:bg-white hover:text-purple-600 transition-colors">
              Make an Enquiry
            </a>
          </div>
        </div>
