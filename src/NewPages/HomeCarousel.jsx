  ...
  {isDialogOpen && (
    ...
    >
      <motion.div
        ...
        className="bg-white w-full max-w-2xl relative overflow-hidden max-h-[90vh] overflow-y-auto my-8"
      >
        {/* Gold accent bar */}
        ...
        <div className="p-8 md:p-12">
          <h2 className="text-3xl md:text-4xl font-light mb-2 text-black" 
              style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Enquiry Form
          </h2>
          <div className="w-16 h-px bg-[#C88A56] mb-6 md:mb-8"></div>
